...
Switch level: /bmad-caveman lite|full|ultra
...
Code/commits/PRs written normal. BMAD artifacts (PRDs, stories, architecture docs) written normal — those are human deliverables.
