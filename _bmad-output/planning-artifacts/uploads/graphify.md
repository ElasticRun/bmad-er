...
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------- | ---------------- |
| Latest commit History[564 Commits](/safishamsi/graphify/commits/v8/)564 Commits   |                                                                                   |                     |                  |
| [.github](/safishamsi/graphify/tree/v8/.github ".github")                         | [.github](/safishamsi/graphify/tree/v8/.github ".github")                         |                     |                  |
| [docs](/safishamsi/graphify/tree/v8/docs "docs")                                  | [docs](/safishamsi/graphify/tree/v8/docs "docs")                                  |                     |                  |
| [graphify](/safishamsi/graphify/tree/v8/graphify "graphify")                      | [graphify](/safishamsi/graphify/tree/v8/graphify "graphify")                      |                     |                  |
| [tests](/safishamsi/graphify/tree/v8/tests "tests")                               | [tests](/safishamsi/graphify/tree/v8/tests "tests")                               |                     |                  |
| [worked](/safishamsi/graphify/tree/v8/worked "worked")                            | [worked](/safishamsi/graphify/tree/v8/worked "worked")                            |                     |                  |
| [.gitattributes](/safishamsi/graphify/blob/v8/.gitattributes ".gitattributes")    | [.gitattributes](/safishamsi/graphify/blob/v8/.gitattributes ".gitattributes")    |                     |                  |
| [.gitignore](/safishamsi/graphify/blob/v8/.gitignore ".gitignore")                | [.gitignore](/safishamsi/graphify/blob/v8/.gitignore ".gitignore")                |                     |                  |
| [AGENTS.md](/safishamsi/graphify/blob/v8/AGENTS.md "AGENTS.md")                   | [AGENTS.md](/safishamsi/graphify/blob/v8/AGENTS.md "AGENTS.md")                   |                     |                  |
| [ARCHITECTURE.md](/safishamsi/graphify/blob/v8/ARCHITECTURE.md "ARCHITECTURE.md") | [ARCHITECTURE.md](/safishamsi/graphify/blob/v8/ARCHITECTURE.md "ARCHITECTURE.md") |                     |                  |
| [CHANGELOG.md](/safishamsi/graphify/blob/v8/CHANGELOG.md "CHANGELOG.md")          | [CHANGELOG.md](/safishamsi/graphify/blob/v8/CHANGELOG.md "CHANGELOG.md")          |                     |                  |
| [LICENSE](/safishamsi/graphify/blob/v8/LICENSE "LICENSE")                         | [LICENSE](/safishamsi/graphify/blob/v8/LICENSE "LICENSE")                         |                     |                  |
| [README.md](/safishamsi/graphify/blob/v8/README.md "README.md")                   | [README.md](/safishamsi/graphify/blob/v8/README.md "README.md")                   |                     |                  |
| [SECURITY.md](/safishamsi/graphify/blob/v8/SECURITY.md "SECURITY.md")             | [SECURITY.md](/safishamsi/graphify/blob/v8/SECURITY.md "SECURITY.md")             |                     |                  |
| [pyproject.toml](/safishamsi/graphify/blob/v8/pyproject.toml "pyproject.toml")    | [pyproject.toml](/safishamsi/graphify/blob/v8/pyproject.toml "pyproject.toml")    |                     |                  |
| View all files                                                                    |                                                                                   |                     |                  |
...
| uv _(recommended)_   | any     | uv --version     | curl -LsSf https://astral.sh/uv/install.sh \| sh |
| pipx _(alternative)_ | any     | pipx --version   | pip install pipx                                 |
...
| MCP configs         | .mcp.json mcp.json mcp\_servers.json claude\_desktop\_config.json — extracts server nodes, package refs, env var requirements                                                                                                                                                                                                                      |
...
Google Drive for desktop `.gdoc`, `.gsheet`, and `.gslides` files are shortcut pointers, not document content. To include native Google Docs, Sheets, and Slides in a headless extraction, install and authenticate thegws CLI, then run:
...
| ------------------------------------ | ----------------------------------------- | --------------------------------------------------- |
| ANTHROPIC\_API\_KEY                  | Claude (Anthropic) backend                | \--backend claude                                   |
| GEMINI\_API\_KEY or GOOGLE\_API\_KEY | Google Gemini backend                     | \--backend gemini                                   |
| OPENAI\_API\_KEY                     | OpenAI or OpenAI-compatible APIs          | \--backend openai                                   |
| DEEPSEEK\_API\_KEY                   | DeepSeek backend                          | \--backend deepseek                                 |
| MOONSHOT\_API\_KEY                   | Kimi Code backend                         | \--backend kimi                                     |
| OLLAMA\_BASE\_URL                    | Ollama local inference URL                | \--backend ollama (default: http://localhost:11434) |
| OLLAMA\_MODEL                        | Ollama model name                         | \--backend ollama (default: auto-detect)            |
| GRAPHIFY\_OLLAMA\_NUM\_CTX           | Override Ollama KV-cache window size      | optional — auto-sized by default                    |
| GRAPHIFY\_OLLAMA\_KEEP\_ALIVE        | Minutes to keep Ollama model loaded       | optional — set 0 to unload after each chunk         |
| AWS\_\* / \~/.aws/credentials        | AWS Bedrock — standard credential chain   | \--backend bedrock (no API key, uses IAM)           |
| GRAPHIFY\_MAX\_WORKERS               | AST parallelism thread count              | optional — also \--max-workers flag                 |
| GRAPHIFY\_MAX\_OUTPUT\_TOKENS        | Raise output cap for dense corpora        | optional — e.g. 32768 for large files               |
| GRAPHIFY\_API\_TIMEOUT               | HTTP timeout in seconds (default: 600)    | optional — also \--api-timeout flag                 |
| GRAPHIFY\_FORCE                      | Force graph rebuild even with fewer nodes | optional — also \--force flag                       |
| GRAPHIFY\_GOOGLE\_WORKSPACE          | Auto-enable Google Workspace export       | optional — set to 1                                 |
| GRAPHIFY\_TRIAGE\_BACKEND            | Backend for graphify prs --triage         | optional — auto-detected from available keys        |
| GRAPHIFY\_TRIAGE\_MODEL              | Model override for triage                 | optional — e.g. claude-opus-4-7                     |
...
**`graphify: command not found` after `pip install graphifyy`**pip installs scripts to a user bin directory that may not be on your PATH. Fix:
...
**`python -m graphify` works but `graphify` command doesn't**Your shell's PATH doesn't include the Python scripts directory. Use `uv` or `pipx` instead of plain `pip`.
...
### Topics
 ...
 tree-sitter  skills  gemini  knowledge-graph  leiden  codex  rag  graphrag  antigravity  claude-code  openclaw 
